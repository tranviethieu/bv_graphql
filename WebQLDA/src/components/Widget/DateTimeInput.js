...
const partern = /^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4} ([0-6][0-9]):([0-6][0-9])$/;
...
class DateTimeInput extends React.Component {
    ...
    componentDidMount() {
        ...
        try {
            if (Moment(value).toDate() <= new Date(1901, 0, 0))
                this.setState({ value: "__/__/____ __:__" })
            else
                this.setState({ value: Moment(value).format("DD/MM/YYYY HH:mm") })
        } catch{
            this.setState({ value: "__/__/____ __:__" })
        }
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        try {
            ...
            var valueStr = Moment(value).format("DD/MM/YYYY HH:mm");
    ...
    toDay() {
        this.state.value = Moment().format("DD/MM/YYYY HH:mm");
    ...
    handleKeyDown(event) {
        ...
        var date = Moment(formated, "DD/MM/YYYY HH:mm").toDate();
        ...
        if (this.props.onChange) {
            this.props.onChange(Moment(str.replace("_", "1"), "DD/MM/YYYY HH:mm").toDate());
        }
    }
