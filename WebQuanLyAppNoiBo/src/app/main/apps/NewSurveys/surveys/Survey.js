    ...
    return (
        <div>
            <AnswerPreview open={open}
                ...
                user={lastAction && lastAction.creator}
                                        ...
                                        },
                                        {
                                            ...
                                            Cell: row =>
                                                <span style={{ marginLeft: "10px", marginRight: "10px", textDecoration: "underline", textDecorationColor: "#C6C6C6", cursor: "pointer", }}
                                                    onClick={_ => {
                                                        if (row.original && row.original.creator && row.original.creator._id) {
                                                            history.push(`/apps/user/history/${row.original.creator._id}`)
                                                        }
                                                    }}
                                                >
                                                    {row.value}
