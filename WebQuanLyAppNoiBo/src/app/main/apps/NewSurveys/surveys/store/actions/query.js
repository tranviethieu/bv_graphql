...
// `
export const QUERY_USERS_SEARCH_BY_SURVEY = gql`
query($begin:DateTime, $end:DateTime,$page: Int, $pageSize: Int, $sorted: [SortedInput], $filtered:[FilteredInput], $surveyIds:[String])
{
   response:users_search_by_survey(begin: $begin, end: $end,surveyIds:$surveyIds, filtered:$filtered, sorted: $sorted, page: $page, pageSize: $pageSize)
    {
        code
...
{
  response:survey_results(filtered:$filtered, sorted: $sorted, page: $page, pageSize: $pageSize)
  {
    code
    message
    data{
