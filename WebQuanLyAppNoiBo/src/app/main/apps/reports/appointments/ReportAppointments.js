      ...
      header={
        <div className="flex flex-1 items-center justify-between p-24 el-HeaderPage">
          <div className="flex flex-col">
            ...
            <FuseAnimate>
              <Typography variant="h6">Thống kê đặt khám</Typography>
            </FuseAnimate>
          </div>
          <DemoFilter
          ...
          <div style={{ position: "absolute", left: "-1000px", top: 0 }}>
            <PDFExport
              paperSize="A4"
              margin="0.7cm"
              fileName={`Báo cáo đặt lịch khám từ ${moment(formFiltered.begin).format("DD/MM/YYYY")} - ${moment(formFiltered.end).format("DD/MM/YYYY")}.pdf`}
