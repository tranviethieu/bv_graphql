...
function convertDataToForm(data) {
    const { departmentId, userName, fullName, code, gender, work, birthday, address, nationIdentity } = data.base;
    var form = { ...data, departmentId, userName, fullName, code, gender, work, birthday, address, nationIdentity, organizationIds: data.organizations && data.organizations.map(o => o._id) };
    form.gender = form.gender == "" ? "" : form.gender == "1" ? "female" : "male";
    return form;
}
...
function Accounts(props) {
    ...
    function convertFormToData(form) {
        ...
        form.gender = form.gender == "" ? "2" : form.gender == "female" ? "1" : "0";
        const { departmentId, userName, fullName, code, work ,birthday, gender, address, nationIdentity} = form;
        form.base = { ...form.base, departmentId, userName, fullName, code, work,birthday:moment(birthday).format("YYYY-MM-DD"), gender, address, nationIdentity};
        return _.omit(form, ['groupPermissions', 'department', 'organizationIds', 'departmentId', 'userName', 'fullName', 'code', 'work','birthday', 'certificate', 'nationIdentity', 'address', 'gender']);
    }
    ...
    function handleSave(form) {
        ...
        console.log("Data submit: " + JSON.stringify(submitData));
    ...
    function handleImportAccount(data) {
        ...
        data.forEach(function (item) {
            if (item["userName"]) {
                ...
                const submitItem = { sipPhone: sipPhone || "", sipPhones: sipPhones || "", sipPassword: sipPassword || "",
                base:{
                    address: base.address || "",
                    certificate: base.certificate || "",
                    departmentName: base.departmentName || "",
                    gender: base.gender || "",
                    nationIdentity: base.nationIdentity || "",
                    code: base.code || "",
                    ...
                    work: base.work || "",
                    title: base.title || "",
                    birthday: base.birthday || new Date(),
                  }};
            ...
            header={
              <div className="flex flex-1 w-full items-center justify-between el-HeaderPage">
                ...
                <DemoFilter
                  ...
                  customElements={[
                    <Button className = "text-white" startIcon={<Icon className = "text-white">import_export</Icon>} onClick={() => {
              ...
              <ReactTableFixedColumns
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    className: "wordwrap",
                    Cell: row =><div>
                      {row.value === "0" ? "Nam" : row.value === "1" ? "Nữ" : "Khác"}
                    </div>
                  },
                  {
                    Header: 'CMND',
                    accessor: 'base.nationIdentity',
                    className: "wordwrap",
                  },
                  {
                    Header: 'Chức danh',
