...
function Articles(props) {
  ...
  function refetchData() {
    // const merged = { ...tableFiltered, filtered: [...formFiltered, textFilter, { id: "type", value: "ADMIN_TUTORIAL,INTERNAL_NEWS", operation: "in" }], }
    // Actions.get_articles(merged, dispatch).then(response => {
    //   setData(response);
    // })
    const { page, pageSize, sorted, filtered } = tableFiltered
    let filter = [...filtered, { id: "type", value: "ADMIN_TUTORIAL,INTERNAL_NEWS", operation: "in" }]
