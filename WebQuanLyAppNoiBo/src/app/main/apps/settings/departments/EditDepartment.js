...
const defaultTimeFrame = ['07:00','08:00','09:00','10:00','11:00','13:00','14:00','15:00','16:00','17:00',]
const initialState = {
  name: '',
  description: '',
  code:'',
...
export default function EditDepartment(props) {
  ...
  function canBeSubmitted() {
    return form._id&&form.name&&form.name.length > 0;
  }
          ...
          <div className="flex flex-1 w-full items-center justify-between el-HeaderPageEdit">
            <div className="flex flex-col items-start max-w-full el-HeaderLeft">
              <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Typography className="normal-case flex items-center sm:mb-12 text-white" component={Link} role="button" to="/apps/departments" color="inherit">
          ...
          />
          {
            ...
            <div>
              <FormControl variant="containted" className="w-full">
                <InputLabel>Chọn từ hệ thống</InputLabel>
                <NativeSelect
