...
export const exportCostColumns = [    
    {
        title: 'Tên chức năng',
        value: 'name',
        width:200
    ...
    {
        title: 'Giờ (x) Hệ số',
        value: (row)=>row.totalEffortHour|| (row.effortHour*(row.developers&&row.developers.length>0? _.sumBy(row.developers,function(o){return o.rank}):1))
    },
    {
        title: 'Developers',
