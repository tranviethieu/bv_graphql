...
import { Button, TextField, Icon, Tabs, Tab, Typography, Switch, FormControlLabel } from '@material-ui/core';
          ...
          <div className="flex flex-1 w-full items-center justify-between el-HeaderPageEdit">
            <div className="flex flex-col items-start max-w-full el-HeaderLeft">
              <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Typography className="normal-case flex items-center sm:mb-12 text-white" component={Link} role="button" to="/apps/sms/campaign-sms" color="inherit">
      ...
      content={
        <div className="p-24 bg-white" id="el-EditSMSCampaign-Cover">
          <ConfirmDialog
            ...
            message="Bạn có chắc chắn muốn xóa chiến dịch gửi tin hiện tại"
            count={5}
          />
          {form && tabValue === 0 &&
            <div>
              ...
              <TextField
                className="mt-8 mb-16"
                label="Nội dung (Sử dụng các từ khóa #DEPARTMENT #TIME #DATE #TEXT #LINK #CODE #NAME #SERVICE cho các trường cần thay thế)"
                name="content"
                value={form.content}
                onChange={handleChange}
                variant="outlined"
