...
import { Paper, Button, Input, Icon, Typography, Switch,FormControl,Checkbox } from '@material-ui/core';
        ...
        <ReactTable
          ...
          columns={[
            ...
            },
            {
              ...
              accessor: 'enableSms',
              width: 70,
              Cell: row => <FormControl>
                <Checkbox checked={row.value} />                
              </FormControl>
            },
            {
              Header: 'notify',
              accessor: 'enableNotify',
              width: 70,
