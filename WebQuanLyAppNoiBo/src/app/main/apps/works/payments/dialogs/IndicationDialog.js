...
export default function IndicationDialog({ code, _id }) {
    ...
    return (
        <Card>
          <CardHeader className="el-CardHeader-FU"
                ...
                }
                {
                    useMemo(() => <div className="w-full px-4 select-up">
                        <FuseChipSelect
                            ...
                            onChange={(e) => e.value&&setSelectedDepartment(e)}
                            textFieldProps={{
                                label: 'Khoa khám',
                                InputLabelProps: {
                                    shrink: true
                    ...
                    useMemo(() => <div className="w-full px-4 select-up">
                        {
                            doctors && <FuseChipSelect
                                ...
                                onChange={(e) => setInForm('doctor', _.omit(e,["value","label"]))}
                                textFieldProps={{
                                    label: 'Bác sỹ',
                                    InputLabelProps: {
                                        shrink: true
            ...
            <CardActions>
                <Button variant="contained" color="secondary" onClick={onSubmit}>Cập nhật & Thanh toán</Button>
            </CardActions>
        </Card>
    )
}
