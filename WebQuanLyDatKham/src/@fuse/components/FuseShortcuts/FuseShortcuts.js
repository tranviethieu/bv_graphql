...
import CallShortcut from './CallShortcut';
import { showUserActionDialog } from '../../../app/main/apps/shared-dialogs/actions'
                    ...
                    item => item && (
                        item.shortcutAction ?
                            item.shortcutAction === "CALL" ?
                                ...
                                <Tooltip title={item.title} placement={props.variant === "horizontal" ? "bottom" : "left"}>
                                    <IconButton className="w-40 h-40 p-0" onClick={() => handleClickOpen(item.shortcutAction)}>
                                        {item.icon ?
                                            (
                                                <Icon>{item.icon}</Icon>
                                            ) :
