...
import { Icon, FormControlLabel, Checkbox, Input, Paper, Button, ButtonGroup, Popper, Grow, Menu, MenuItem, ClickAwayListener, FormGroup, InputLabel, OutlinedInput } from '@material-ui/core';
...
export default function ({ searchOption, filterOption, menuOption, fieldOption, exportOption, customElements, createOption, className, placeHolder, ...props }) {
    ...
    return (
        <div className={clsx(className, "el-DemoFilter")}>
          <ButtonGroup variant="contained" color="primary" aria-label="table filter" className = "el-DemoFilter-Button">
                ...
                <ThemeProvider theme={mainTheme}>
                  <FuseAnimate animation="transition.slideDownIn" delay={300}>
                    <Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8" elevation={1}>
                      ...
                      <Input
                        placeholder={ placeHolder ?? "Từ khóa" }
                        ...
                        value={searchText}
                        inputProps={{
                          'aria-label': placeHolder ?? "Từ khóa"
                        }}
                      />
                    </Paper>
                  </FuseAnimate>
            ...
            }
            {
              ...
              >
                <Icon className="mr-4 text-white">add</Icon>
