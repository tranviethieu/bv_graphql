          ...
          <tbody>
            {
              props.data && props.data.map((item, index) =>
                <tr key={index}>
                  ...
                  <td style={{ wordWrap: "break-word", textAlign: "center", borderRight: "1px solid #333", borderTop: "1px solid #333", width: "70px" }}>
                    {item.appointment.state === "WAITING" ? "Chờ duyệt" : item.appointment.state === "CANCEL" ? "Đã hủy" : item.appointment.state === "SERVED" ? "Đã đến khám" : "Đã duyệt"}
                  </td>
                </tr>
              )
            }
