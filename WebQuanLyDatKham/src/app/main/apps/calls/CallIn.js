...
function CallIn() {
  ...
  // const [playingFile] = useState(null);
  function fetchData(state, startDateRealtime, endDateRealtime, seacrchValue) {
    const { page, pageSize } = state;
    var { filtered } = state;
    Actions.getCallIns({ page, pageSize, filtered }, dispatch).then(response => {
      setCalls({ ...response, pageSize });
    })
  }
  function handleSearch(){
    ...
    fetchData({page: calls.page, pageSize: calls.pageSize,
      filtered: [
          ...
          <div className="flex flex-1 items-center justify-between p-24 el-HeaderPage">
            <div className="flex items-center">
              <FuseAnimate animation="transition.expandIn" delay={300}>
                <Icon className="text-32 mr-0 sm:mr-12">call_received</Icon>
              </FuseAnimate>
              <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                <Typography className="hidden sm:flex" variant="h6">Danh sách cuộc gọi vào ({calls.records? calls.records.toLocaleString('vi-VN') : 0})</Typography>
              </FuseAnimate>
            </div>
          </div>
        }
          ...
          <div className="p-12 el-coverContent">
            ...
            <div className="el-block-report">
              ...
              <div className='el-fillter-report-action'>
                ...
                <div className="el-flex-item flex-item-flex1 mt-16">
            ...
            <div className="w-full p-12 el-block-Call el-block-report">
              ...
              <div className="box-table-scroll">
                <ReactTable
                  className="el-TableCall -striped -highlight"
                  data={calls.data}
                  pages={calls.pages}
                  sortable={false}
