            ...
            <div>
              ...
              <div style={{ position: "absolute", left: "-1000px", top: 0 }}>
                <PDFExport
                  ...
                  margin="0.7cm"
                  landscape = "true"
                  fileName = {`Báo cáo đặt khám trong ngày từ ${moment().format("DD/MM/YYYY")}.pdf`}
          ...
          <div className="p-12 el-coverContent" id="el-RealtimeDashboardApp-Cover">
            {tabValue === 0 && form && (
              <div className="el-RealTime-Cover">
                ...
                >
                  {realtimeData ?
                    <div className="el-block-report w-full">
                      ...
                      >
                          ...
                          <div class="report-box-content">
                            <div class="report-col rp-min-200">
                              <div class="rp-col-in rp-full-size rp-bg-blue report-p-1 d-flex flex-center">
                                <p class="rp-text-center rp-text-white"><span>{realtimeData.total}</span><br/>Đặt khám<br/><span>Trong ngày</span></p>
                              </div>
                            </div>
                              ...
                              <div class="report-row mb-16">
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.crms}</span><br/>Đặt khám qua <br/><b>CRM</b></p>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.fbchats}</span><br/>Đặt khám qua <br/><b>Facebook</b></p>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.webs}</span><br/>Đặt khám qua <br/><b>Website</b></p>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.zalochats}</span><br/>Đặt khám qua <br/><b>Zalo</b></p>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.apps}</span><br/>Đặt khám qua <br/><b>Ứng dụng</b></p>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                                    <p class="rp-text-center"><span className = "text-blue">{realtimeData.hospitals}</span><br/>Đặt khám qua <br/><b>Bệnh viện</b></p>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size rp-bg-blue report-p-1 d-flex flex-center">
                                    <div class="d-flex flex-center">
                                      ...
                                      <p class="rp-text-white"><span>{realtimeData.serves}</span><br/>Đã đến khám</p></div>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size rp-bg-red report-p-1 d-flex flex-center">
                                    <div class="d-flex flex-center">
                                      ...
                                      <p class="rp-text-white"><span>{realtimeData.cancels}</span><br/>Đã hủy</p></div>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size rp-bg-green report-p-1 d-flex flex-center">
                                    <div class="d-flex flex-center">
                                      ...
                                      <p class="rp-text-white"><span>{realtimeData.approves}</span><br/>Đã duyệt</p></div>
                                  </div>
                                </div>
                                <div class="report-col report-flex-1 flex-center">
                                  <div class="rp-col-in rp-full-size rp-bg-yl report-p-1 d-flex flex-center">
                                    <div class="d-flex flex-center">
                                      ...
                                      <p class="rp-text-white"><span>{realtimeData.waitings}</span><br/>Chưa xác nhận </p></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        {/* <div className="el-card-white">
                          ...
                          <div className="el-card-white">
                          <Widget2 widget={{ value: realtimeData.cancels, title: "Đã hủy" }} color="text-orange" />
                          </div>
                          <div className="el-card-white">
            ...
            <div className="w-full p-12 el-cover-table1 bg-white">
              <div className="w-full p-12 el-TitleHeader-Table flex flex-row">
                <h3 className="" style={{ width: 300 }}>Danh sách đặt khám</h3>
                <div className="flex w-full" style={{ justifyContent: "flex-end" }}>
                  <RadioGroup
                    aria-label="Status"
                    name="status"
                    className=""
              ...
              {
                useMemo(() => <ReactTableFixedColumns
                  ...
                  columns={[
                    ...
                    // }, 
                    {
                      Header: "STT",
                      width: 120,
                      accessor: "appointmentOrder",
                      fixed: "left",
                      Cell: row => <div style={{ minWidth: "30px", textAlign: 'right' }}>{row.value ? row.value : "0"}</div>
                    },
                    {
                      Header: "Khách hàng",
                    ...
                    },
                    {
                      ...
                      fixed: "right",
                      Cell: row => <div>
                        <Tooltip title={row.value === "WAITING" ? "Chờ duyệt" : row.value === "CANCEL" ? "Đã hủy" : row.value === "SERVED" ? "Đã đến khám" : "Đã duyệt"} placement="bottom">
