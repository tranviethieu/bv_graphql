...
const createLineChartFromData = (chartData) => {
  ...
  if (chartData) {
    return (
      {
        labels: chartData.reverse().map(c => c.date),
        datasets: [
          {
            fill: false,
            borderColor: "#808080",
            ...
            borderWidth: 1,
            data: chartData.reverse().map(c => c.total),
          ...
          },
          {
            ...
            borderColor: '#F6993F',
            label: "Chưa xác nhận",
            data: chartData.reverse().map(d => d.waitings),
            borderWidth: 1,
          ...
          },
          {
            ...
            label: "Đã đến khám",
            data: chartData.reverse().map(d => d.serves),
            borderWidth: 1,
          ...
          },
          {
            ...
            borderColor: '#38C172',
            label: "Đã duyệt",
            data: chartData.reverse().map(d => d.approves),
            borderWidth: 1,
          ...
          },
          {
            ...
            borderColor: '#E3342F',
            label: "Đã hủy",
            data: chartData.reverse().map(d => d.cancels),
            borderWidth: 1,
...
const createPieChartFromData = (data, type) => {
  ...
  var labelState = ["Đã hủy", "Đã duyệt", "Chưa xác nhận", "Đã đến khám"]
  var labelChannel = ['CRM', "Website", "Ứng dụng", "FacebookChat", "ZaloChat"]
  var stateColor = ['royalblue', '#38C172', '#F6993F', '#E3342F']
  var channelColor = ["#4682B4", "#38C172", '#E3342F','#F6993F',"#63FF84" ]
  return {
...
function RealtimeDashboardApp(props) {
  ...
  function getReportUserActions() {
    const filtered = [{ id: 'action', value: 'APPOINTMENT' }, { id: 'createdTime', value: `${moment(formFiltered.begin).format("DD/MM/YYYY")},${moment(formFiltered.end).format("DD/MM/YYYY")}`, operation: "between" }];
        ...
        <div className="flex flex-1 items-center justify-between p-24 el-HeaderPage">
          <div className="flex flex-col">
            <div className="flex items-center mb-4">
              <Icon className="text-18 el-TitleIcon">home</Icon>
              <Icon className="text-16 el-TitleIcon">chevron_right</Icon>
          ...
          <DemoFilter
            ...
            customElements={[
              <Button className = "text-white" startIcon={<Icon>import_export</Icon>} variant="contained" onClick={e => { exportReportToExcel(formFiltered) }}>Xuất Excel</Button>,
              <Button className = "text-white" startIcon={<Icon>assignment</Icon>} variant="contained" onClick={() => { pdfExportComponent.save(); }}>In báo cáo</Button>]}
          />
              ...
              >
                <div class="report-box">
                  <div class="report-box-content">
                    <div class="report-col rp-min-200">
                      <div class="rp-col-in rp-full-size rp-bg-blue report-p-1 d-flex flex-center">
                        <p class="rp-text-center rp-text-white"><span>{pieData.total}</span><br/>Đặt khám<br/><span>Tổng</span></p>
                      </div>
                    </div>
                    <div class="report-col report-col-grow">
                      <div class="report-row mb-16">
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.crms}</span><br/>Đặt khám qua <br/><b>CRM</b></p>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.fbchats}</span><br/>Đặt khám qua <br/><b>Facebook</b></p>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.webs}</span><br/>Đặt khám qua <br/><b>Website</b></p>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.zalochats}</span><br/>Đặt khám qua <br/><b>Zalo</b></p>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.apps}</span><br/>Đặt khám qua <br/><b>Ứng dụng</b></p>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size report-p-1 rp-bd-sh d-flex flex-center">
                            <p class="rp-text-center"><span className = "text-blue">{pieData.hospitals}</span><br/>Đặt khám qua <br/><b>Bệnh viện</b></p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size rp-bg-blue report-p-1 d-flex flex-center">
                            <div class="d-flex flex-center">
                              <img src="./static/images/dakham.png" alt="" class="rp-icon"/>
                              <p class="rp-text-white"><span>{pieData.serves}</span><br/>Đã đến khám</p></div>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size rp-bg-red report-p-1 d-flex flex-center">
                            <div class="d-flex flex-center">
                              <img src="./static/images/dahuy.png" alt="" class="rp-icon"/>
                              <p class="rp-text-white"><span>{pieData.cancels}</span><br/>Đã hủy</p></div>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size rp-bg-green report-p-1 d-flex flex-center">
                            <div class="d-flex flex-center">
                              <img src="./static/images/daduyet.png" alt="" class="rp-icon"/>
                              <p class="rp-text-white"><span>{pieData.approves}</span><br/>Đã duyệt</p></div>
                          </div>
                        </div>
                        <div class="report-col report-flex-1 flex-center">
                          <div class="rp-col-in rp-full-size rp-bg-yl report-p-1 d-flex flex-center">
                            <div class="d-flex flex-center">
                              <img src="./static/images/chuaxacnhan.png" alt="" class="rp-icon"/>
                              <p class="rp-text-white"><span>{pieData.waitings}</span><br/>Chưa xác nhận </p></div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                {/* <div className="el-card-white">
                  ...
                  <div className="el-card-white">
                  <Widget2 widget={{ value: pieData.cancels, title: "Đã hủy" }} color="text-orange" />
                  </div>
                  <div className="el-card-white">
