...
import { Button, TextField, Dialog, DialogActions, DialogContent, DialogContentText, AppBar, Typography, FormLabel } from '@material-ui/core';
    ...
    return (
        <Dialog open={open} onClose={onCloseDialog} aria-labelledby="form-dialog-title" classes={{ paper: "w-full h-auto m-24 rounded-8" }}>
          ...
          <div style={{ pointerEvents: "none" }}>
            ...
            <AppBar position="static" elevation={1} style={{ backgroundColor: "#106ba3" }}>
              <div className="m-8">
                ...
                <div className="p-1">
                  {form.questions && (
                    <div className="p-8 sm:p-16">
                      <FormLabel style={{ fontWeight: "bold", fontSize: "18px", color: "#106ba3", marginBottom: "10px" }}>THÔNG TIN</FormLabel>
                      ...
                      {/* <Divider /> */}
                      <div className="mt-5">
                        <FormLabel style={{ fontWeight: "bold", fontSize: "18px", color: "#106ba3", marginBottom: "10px" }}>NỘI DUNG</FormLabel>
                        <div className='mt-5'>
                          {
