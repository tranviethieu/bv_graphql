...
function Departments(props) {
    ...
    return (
        <FusePageCarded
          ...
          header={
            <div className="flex flex-1 w-full items-center justify-between el-HeaderPage" id = "el-DepartmentsApp-Header">
              ...
              <DemoFilter
                createOption={{ onClick: () => history.push("/apps/departments/new") }}
              />
