...
import { uploadFile as uploadFile } from 'app/store/actions';
...
function ScanResultForm(props) {
    const classes = useStyles(props);
    const { onScanChange, scan } = props;
    const { form, handleChange, setInForm } = useForm(scan);
    ...
    return (
        <div className = "el-coverScanResultForm">
          <Typography className="text-17 p-4">Kết quả chụp chiếu</Typography>
          <div>
            <div className="pt-4 pb-4 pl-4">
              <FormLabel className="pb-2">Hình ảnh chụp chiếu</FormLabel>
