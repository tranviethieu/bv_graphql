...
function ReportSMSLogs(props) {
  ...
  function searchReportSMSLogs(state) {
    ...
    if (form.campaignId.value !== null && form.campaignId.value !== '') {
      let filtered = [{ id: 'campaign_id', value: form.campaignId.value }, {
        id: "createdTime",
        value: `${moment(form.begin).startOf('day').format("YYYY-MM-DD HH:mm:ss")},${moment(form.end).endOf('day').format("YYYY-MM-DD HH:mm:ss")}`,
        operation: "between"
      }];
  ...
  function fetchReportData() {
    ...
    if (form.campaignId.value !== null && form.campaignId.value !== '') {
      let filtered = [
        { id: 'campaign_id', value: form.campaignId.value },
        {
          id: "createdTime",
          value: `${moment(form.begin).startOf('day').format("YYYY-MM-DD HH:mm:ss")},${moment(form.end).endOf('day').format("YYYY-MM-DD HH:mm:ss")}`,
          operation: "between"
          ...
          <div className="p-12 el-coverContent" id="el-ReportSMSLogs-content">
            <div className="el-block-report">
              ...
              <div className="el-fillter-report-action">
                <div className="el-flex-item flex-item-flex1">
                  <MuiPickersUtilsProvider utils={DateFnsUtils} locale={viLocale}>
                    <DatePicker
                      ...
                      value={form.begin ? moment(form.begin).format("YYYY-MM-DD") : moment().format("YYYY-MM-DD")}
                ...
                <div className="el-flex-item flex-item-flex1">
                  <MuiPickersUtilsProvider utils={DateFnsUtils} locale={viLocale}>
                    <DatePicker
                      ...
                      label="Ngày kết thúc"
                      inputVariant="outlined"
                      value={form.end ? moment(form.end).format("YYYY-MM-DD") : moment().format('YYYY-MM-DD')}
                ...
                >
                  <Button variant="contained" className="pb-8 my-8" color="secondary" onClick={searchReportSMSLogs}>
