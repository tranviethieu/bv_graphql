...
function PollSmileyAdd(props) {
    ...
    const { form, handleChange, resetForm,setInForm } = useForm({value:'', display: "IMAGE", image: "/assets/images/emoji/angry.png", label: ""});
    ...
    return (
        <form onSubmit={handleSubmit} className = "el-PollSmileyAdd">
          <div>
            {
          ...
          <ListItem className="flex flex-1 pl-16">
            ...
            <FormControl className="m-8 w-1/3">
              ...
              >
                ...
                <option value="TEXTIMAGE">Nhãn và biểu tượnng</option>
              </NativeSelect>
            </FormControl>
            {
