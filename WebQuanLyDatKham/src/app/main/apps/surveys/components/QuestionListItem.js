...
import { Button, TextField, Checkbox, FormControl, InputLabel, NativeSelect, Icon, Typography, IconButton } from '@material-ui/core';
...
function QuestionListItem(props) {
    ...
    return (
        ...
        <div className="mt-10 p-24" style={{ width: "80%", margin: "auto", marginTop: "30px", boxShadow: "0 4px 8px 0 rgba(255, 255, 255, 0.3), 0 6px 20px 0 rgba(0, 0, 0, 0.19", borderRadius: "5px", }}>
          ...
          <FormControl className="w-full">
            <InputLabel>Lưu vào hồ sơ người dùng</InputLabel>
            <NativeSelect
              className="mt-8 mb-16"
              name="userField"
              fullWidth
              ...
              onChange={handleChange}
            >
              <option value="UNDEFINED">Không lưu</option>
              <option value="FULLNAME">Tên</option>
              <option value="EMAIL">Email</option>
              <option value="PHONE">Số điện thoại</option>
              <option value="BIRTHDAY">Năm sinh</option>
              <option value="AGE">Tuổi</option>
              <option value="GENDER">Giới tính</option>
              <option value="ADDRESS">Địa chỉ</option>
              <option value="HOBBIES">Sở thích</option>
              <option value="WORK">Nghề nghiệp</option>
              <option value="PROVINCE">Tỉnh/Thành phố</option>
              <option value="DISTRICT">Quận/Huyện</option>
              <option value="FACEBOOK_ID">Facebook</option>
              <option value="ZALO_ID">Zalo</option>
              <option value="GOOGLE_ID">Google</option>
          ...
          <div className="w-full text-right">
            ...
            {
              props.isLast && props.isLast === true && <Button style={{ marginLeft: "10px" }} onClick={onSaveSurvey} className="justify-right" variant="contained" color="primary"><Icon>save</Icon>Lưu khảo sát</Button>
            }
          </div>
        </div>
    )
