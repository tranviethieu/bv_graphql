...
import { showMedicalConclusionDialog } from "./actions";
import { showResultPreviewDialog } from "../indications/actions";
...
export default function WaitingIndications(props) {
  ...
  const [formFiltered, setFormFiltereds] = useState([
    { id: "process", value: "WATING_CONCLUSION" },
  ]);
          ...
          <div className="flex flex-col">
            ...
            <FuseAnimate>
              <Typography variant="h6">
                {medicalSessions.records} Bệnh nhân đang khám
              </Typography>
            </FuseAnimate>
          </div>
          <DemoFilter
                        ...
                        <React.Fragment>
                          ...
                          <Menu {...bindMenu(popupState)}>
                            ...
                            {/* <MenuItem
                              onClick={(e) =>
                                dispatch(
                                  showResultPreviewDialog({
                                    indications: row.original.indications,
                                  })
                                )
                              }
                            >
                              Xem kết quả chỉ định
                            </MenuItem> */}
                            <MenuItem
                              onClick={(e) =>
                                dispatch(
                                  showMedicalConclusionDialog({
