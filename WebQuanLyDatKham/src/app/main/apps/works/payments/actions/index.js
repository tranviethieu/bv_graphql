...
export function save_medical_session(data, dispatch) {
...
//list đã thanh toán
export function get_transactions(variables, dispatch){
  return graphqlService.query(QUERY_TRANSACTIONS, variables, dispatch);
}
