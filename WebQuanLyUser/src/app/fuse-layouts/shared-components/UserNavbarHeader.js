...
function UserNavbarHeader(props)
{
    ...
    return (
        ...
        >
          ...
          <Typography className="email text-13 mt-8 opacity-50 whitespace-no-wrap" color="inherit">{user.data.email ? user.data.email : "Chưa có thông tin email"}</Typography>
          <Avatar
