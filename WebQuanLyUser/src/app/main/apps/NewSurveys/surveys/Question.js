...
function Question(props) {
    ...
    return (
        <div>
            <AnswerPreview open={open} onCloseDialog={handleCloseDialog}
                user={lastAction && { phoneNumber: lastAction.phoneNumber, fullName: lastAction.user ? lastAction.user.fullName : '' }}
                result={lastAction && lastAction.survey_result && lastAction.survey_result.data} title={lastAction && lastAction.survey_result && lastAction.survey_result.survey.title} />
            <FusePageSimple
                classes={{
