...
export function getSurveyFrequenceData(begin, end, surveyIds, rangNumb, type, dispatch) {
    return graphqlService.query(GET_SURVEY_FREQUENCE_DATA, { begin, end, surveyIds, rangNumb, type }, dispatch)
}
export function getQuestionsAnalysticData(quesids, begin, end, type, dispatch) {
    return graphqlService.query(GET_QUESTIONS_ANALYSTIC_DATA, { quesids, begin, end, type }, dispatch)
}

//trongpv - for survey dashboard
export function getSurveysGeneralReport(begin, end, surveyIds, type, dispatch) {
    return graphqlService.query(SURVEY_GENERAL_REPORT, { begin, end, surveyIds, type }, dispatch)
}
