...
function FacebookBotWidget() {
  ...
  useEffect(() => {
    if (drawer.data && drawer.data.type === "FACEBOOK_BOT") {
  ...
  return (
    <SwipeableDrawer
      className="h-full absolute z-30 el-FacebookBotWidgetCove"
      variant="temporary"
      anchor="right"
      open={(drawer.open && drawer.data && drawer.data.type === "FACEBOOK_BOT") ? true : false}
      onClose={onClose}
      onOpen={onOpen}
    ...
    >
      <div style={{ width: "780px", height: "100%", backgroundColor: "transparent", display: "flex", marginTop: "64px", color: "#595959" }} id="el-FacebookBotWidget">
              ...
              {pages.map((page, index) => {
                ...
                return (
                  <ListItem key={index} button>
                    ...
                    {/* <Button style={{ maxWidth: "130px", minWidth: "130px", width: "130px", height: "40px" }} variant="outlined" color={page.active === true ? "primary" : "secondary"} className={classes.button} onClick={e => {
                          if (page.active === true) {
                        ...
                        }}>{page.active === true ? "Ngắt kết nối" : "Kết nối"}</Button> */}
                  </ListItem>
                );
              })}
            </List>
...
export default FacebookBotWidget;
