...
function ReportCallRingGroup(props) {
    ...
    return (
        <FusePageSimple
          ...
          header={
            <div className="flex flex-1 items-center justify-between p-24 el-ReportCallRingGroup-Header">
            ...
            <div className="p-12 el-coverContent">
              <div className="el-block-report">
                ...
                <div className="el-fillter-report-action">
                  ...
                  >
                    <Button variant="contained" className="mx-20" color="secondary" onClick={searchCallInReportByRingGroup}>
