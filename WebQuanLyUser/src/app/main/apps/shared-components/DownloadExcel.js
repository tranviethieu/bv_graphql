...
export  function DownloadExcel({ columns, data, name }) {
    
    return (
        <ExcelFile element={<IconButton><Icon>cloud_download</Icon></IconButton>} fileName={name}>
            {
                data && columns && name &&
...
export function DownloadExcelMultiSheet({ dataSheets, name,element }) {
    ...
    return (
        <ExcelFile element={element||<IconButton><Icon>cloud_download</Icon></IconButton>} fileName={name}>
