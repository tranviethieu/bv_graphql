      ...
      <CardContent>
        ...
        }
        {
          ...
          <div id="el-ButtonGroupFloatUA">
            ...
            <Button className='btn-blue md:w-1/2 sm:w-1/2 p-4 m-4' onClick={e => dispatch(showAppointmentDialog({ phoneNumber: user.phoneNumber }))} variant="contained" id="el-ButtonCreateAppointment">
              Tạo lịch khám
                </Button>
          </div>
        }
