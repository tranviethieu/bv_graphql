              ...
              <div className="p-12 el-coverContent" id = "el-ReportSMSByPhone-content">
                <div className="el-block-report">
                  ...
                  <div className="el-fillter-report-action">
                    ...
                    >
                      <Button variant="contained" className="mx-20" color="secondary" onClick={searchReportSMSByPhone}>
                  ...
                  <ReactTable
                    ...
                    columns={[
                      ...
                      },
                      {
                        ...
                        Cell: row => <div>{row.value === 'male' ? <div>Nam</div> : row.value === "female" ? <div>Nữ</div> : "Không xác định"}</div>
                      },
                      {
                        Header: "Ngày sinh",
                        accessor: "BirthDay",
